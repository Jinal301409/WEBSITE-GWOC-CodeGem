    ...
    orders.map((order) => {
        ...
        <nav className="bg-[#2D1B0E] border-b-8 border-amber-900/40 shadow-[0_25px_50px_-12px] shadow-amber-900/30 sticky top-0 z-50 font-vibes">
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 w-full max-w-7xl px-4">
                <div className="h-1.5 bg-linear-to-r from-transparent via-amber-600/50 to-transparent shadow-[0_0_20px] shadow-amber-500/30"></div>
                ...
                <div className="flex justify-between items-center h-16 lg:h-20">
                    ...
                    <div className="shrink-0 flex items-center space-x-2 group">
                        ...
                        <div className="flex flex-col ml-1 md:ml-2">
                            <NavLink
                                to="/"
                                className="text-lg md:text-xl lg:text-2xl xl:text-3xl bg-linear-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent font-monsieur tracking-wider whitespace-nowrap"
                            >
                                Foodie-Frenzy
                            </NavLink>
                            <div className="h-0.75 bg-linear-to-r from-amber-600/30 via-amber-400/50 to-amber-600/30 w-full mt-1" />
                        </div>
                    </div>
            ...
            {showLoginModal && (
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4">
                    <div className="bg-linear-to-br from-[#2D1B0E] to-[#4a372a] rounded-xl p-8 w-full max-w-md relative border-4 border-amber-700/30">
                        <button
                            onClick={() => navigate('/')}
                        ...
                        <h2 className="text-3xl font-bold bg-linear-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent mb-6 text-center">
                            Foodie-Frenzy
                        </h2>
